module github.com/kubernetes-sigs/kro/tools/lsp/server
...
// Broken depenceny for GOPROXY=direct
// https://github.com/tliron/glsp/issues/45
replace github.com/tliron/kutil => github.com/tliron/go-kutil v0.3.11
