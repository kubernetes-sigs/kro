...
func TestChangeDescriptions(t *testing.T) {
	...
	tests := []struct {
		...
		{"enum constraint added", Change{Path: "spec.e", ChangeType: EnumConstraintAdded, NewValue: "[blue]"},
			[]string{"Enum constraint", "[blue]", "added"}},
		{"enum constraint removed", Change{Path: "spec.e", ChangeType: EnumConstraintRemoved, OldValue: "[blue]"},
			[]string{"Enum constraint", "[blue]", "removed"}},
		...
		{"validation rules changed", Change{Path: "spec.v", ChangeType: ValidationRulesChanged},
			[]string{"Validation rules", "spec.v"}},
		{"nullable removed", Change{Path: "spec.n", ChangeType: NullableRemoved},
			[]string{"Nullable values", "no longer allowed", "spec.n"}},
		{"nullable added", Change{Path: "spec.n", ChangeType: NullableAdded},
			[]string{"Nullable values", "now allowed", "spec.n"}},
		{"format changed", Change{Path: "spec.f", ChangeType: FormatChanged, OldValue: "date", NewValue: "date-time"},
			[]string{"Format changed", "date", "date-time"}},
		...
		{"preserve unknown added", Change{Path: "spec.u", ChangeType: PreserveUnknownFieldsAdded},
			[]string{"Unknown fields", "now preserved", "spec.u"}},
		{"topology changed", Change{Path: "spec.t", ChangeType: TopologyChanged},
			[]string{"topology changed", "spec.t"}},
		{"unclassified schema change", Change{Path: "spec.x", ChangeType: UnclassifiedSchemaChange},
			[]string{"Schema field", "spec.x", "cannot be classified safely"}},
