...
- **[Graph](crds/graph.md)** - A namespaced set of resources composed with CEL expressions and reconciled directly, without generating a new API. Alpha, behind the `GraphKind` feature gate.
