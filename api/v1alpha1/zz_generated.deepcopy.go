...
func (in *CELMetrics) DeepCopyInto(out *CELMetrics) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CELMetrics.
func (in *CELMetrics) DeepCopy() *CELMetrics {
	if in == nil {
		return nil
	}
	out := new(CELMetrics)
