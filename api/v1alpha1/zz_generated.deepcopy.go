...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Iterator) DeepCopyInto(out *Iterator) {
	*out = *in
	in.Render.DeepCopyInto(&out.Render)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Iterator.
func (in *Iterator) DeepCopy() *Iterator {
	if in == nil {
		return nil
	}
	out := new(Iterator)
