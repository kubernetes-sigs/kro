...
<EngineCapabilities
  links={{
    ...
    celExpressions: '/docs/concepts/rgd/cel-expressions',
    dependencyOrdering: '/docs/concepts/rgd/dependencies-ordering',
    conditionalResources: '/docs/concepts/rgd/resource-definitions/conditional-creation',
    collections: '/docs/concepts/rgd/resource-definitions/collections',
