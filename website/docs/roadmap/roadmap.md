...
---
_Last updated: 2025-11-12 17:47:39Z_

Kro’s roadmap highlights **active initiatives**, **planned features**, and **proposal areas open for feedback**.

This file is auto-generated from [GitHub issues](https://github.com/kubernetes-sigs/kro/issues) labeled with `roadmap-item`, `priority/*`, `kind/feature`, `needs/community-input`, or `area/*`.
...
### Area: General
- [Resources not deleted properly when using RGD with nested ArgoCD clusters](https://github.com/kubernetes-sigs/kro/issues/760) — Assigned to @a-hilaly
...
### Area: documentation
- [Add `Known Limitations` Section on website](https://github.com/kubernetes-sigs/kro/issues/621) — Assigned to @uttam282005
### Area: testing
- [Continuous performance testing](https://github.com/kubernetes-sigs/kro/issues/610) — Assigned to @a-hilaly
### Area: typesystem
- [0.6.0 - `type mismatch in resource -  returns type "list(__type_schema...@idx)" but expected "list(object)"`](https://github.com/kubernetes-sigs/kro/issues/783) — Assigned to @a-hilaly
