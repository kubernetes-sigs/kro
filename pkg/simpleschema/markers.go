...
const (
	...
	// MarkerTypeKubectlPrint marks a scalar field for CRD printer column generation.
	MarkerTypeKubectlPrint MarkerType = "kubectlPrint"
)
...
func markerTypeFromString(s string) (MarkerType, error) {
	...
	case MarkerTypeRequired, MarkerTypeDefault, MarkerTypeDescription,
		...
		MarkerTypeMaxItems, MarkerTypeKubectlPrint:
